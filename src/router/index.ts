	...
	},
	{
		...
		children: [
			...
			},
			{
				...
				path: "collections",
				component: () => import("../views/user/collections/CollectionsPage.vue"),
				meta: { requiresLogin: true },
				props: true,
			},
			{
				...
				component: () => import('../views/user/collections/AddPage.vue'),
				meta: { requiresLogin: true },
			},
			{
				name: 'edit_collection',
				path: "collections/:collection_id",
				component: () => import('../views/user/collections/EditPage.vue'),
				meta: { requiresLogin: true },
			}
		],
	},
